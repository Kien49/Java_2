            ...
            switch (option) {
                ...
                case 4:
                    if (monHocList.size() == 0) {
                        System.out.println("Danh sách mon hoc trống!");
                        continue;
                    }
                    System.out.printf("Danh sách %d mon hoc: \n", monHocList.size());
                ...
                case 5:
                    MonHoc m = new MonHoc();
                    System.out.print("\tNhập mã mon hoc: ");
                    m.setMaMonHoc(in.nextLine());
                    System.out.print("\tNhập tên mon hoc: ");
                    m.setTenMonHoc(in.nextLine());
